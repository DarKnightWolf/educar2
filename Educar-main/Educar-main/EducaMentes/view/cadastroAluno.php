...
<div>
    <form id="formCadastroAluno" onsubmit="return validarSenhas()" action="../control/cadastroAlunoControl.php" method="POST">
        <h1>Cadastro Aluno</h1> <!-- Centralizado -->
        <br>
        <label for="nome">Nome:</label> <!-- Alinhado à esquerda -->
        <input type="text" name="nome" placeholder=" Insira o nome completo do aluno." required>
        <br>
        <label for="email">Email:</label> <!-- Alinhado à esquerda -->
        <input type="email" name="email" placeholder=" Insira o e-mail do responsável." required>
        <br>
        <br>
        <label for="matricula">Matricula:</label> <!-- Alinhado à esquerda -->
        <input type="matricula" name="matricula" placeholder=" Insira a matricula do aluno." required>
        <br>
...
<!-- Enviar para o banco de dados/ Mostrar se foi efetuaddo com sucesso / retornar à home. -->
